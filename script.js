...
const textoResultado = document.querySelector(".texto-resulatado");

const perguntas = [
{
   enunciado: "Assim que saiu da escola você se depara com uma nova tecnologia, um chat que consegue responder todas as dúvidas que uma pessoa pode ter, ele também gera imagens e áudios hiper-realistas. Qual o 0primeiro pensamento?",
   alternativas: [
    "Isso é assustador!",
     "Isso é maravilhoso!"
    ]
